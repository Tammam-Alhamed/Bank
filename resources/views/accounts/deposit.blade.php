...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div style="font-size: 20px; font-weight: bold" class="card-header">{{ __('Making new deposit') }}</div>
                <div class="card-body">
                    <form action="{{route('account.add' , ['id' => Auth::user()->customer->account->id])}}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
